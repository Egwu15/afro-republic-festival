        ...
        <main>
            ...
            >
                ...
                <div className="relative py-24 text-center text-white">
                    ...
                    <p className="mx-auto mt-6 max-w-3xl px-4 text-2xl md:px-0">
                        The world’s biggest celebration of <span className="text-yellow-300">Afrobeats, Amapiano, and global sounds is BACK!</span>{' '}
                        Join thousands of music lovers at an unforgettable festival filled with music, culture, and pure energy.
                    </p>
            ...
            <section className="bg-custom-green pb-9 text-center">
                ...
                <div className="mx-8 mt-8 grid max-w-5xl md:mx-auto md:grid-cols-3 md:gap-20">
                    <PriceCard
                        price={10}
                        header="STANDARD TICKET"
                        description="Dance all day & night with full festival access."
                        backgroundColor="#FAD205"
                    />
                    <PriceCard
                        price={30}
                        header="VIP TICKET"
                        description="Skip the lines, enjoy exclusive lounges & premium bars."
                        backgroundColor="#0BF8C4"
                    />
                    <PriceCard
                        price={50}
                        header="VVIP TICKET"
                        description="Ultimate luxury with front-row views, bottle service & elite perks."
                        backgroundColor="#F56144"
                    />
                </div>
            </section>
            <section className="bg-custom-yellow overflow-hidden px-2 py-6">
                <h3 className="animate-marque font-display text-nowrap md:text-5xl">
                    ⭐ 30 BEST OF BEST ⭐ 30 BEST OF BEST ⭐ 30 BEST OF BEST ⭐ 30 BEST OF BEST ⭐ 30 BEST OF BEST ⭐ 30 BEST OF BEST ⭐ 30 BEST OF
                    BEST ⭐{' '}
                </h3>
            </section>
            <section className="mx-auto mt-16">
                ...
                <p className="mx-auto mt-7 max-w-md text-center">
                    Experience chart-topping artists, legendary DJs, and breakout stars bringing Afrobeats, Amapiano, Dancehall, Hip-Hop, and more to
                    one stage.
                </p>
            </section>
            ...
            <section className="bg-custom-light-green py-14">
                <div className="md:mx-auto md:max-w-5xl">
                    <h3 className="font-display mt-14 text-7xl">
